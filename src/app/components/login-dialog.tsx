    ...
    try {
      ...
      if (isSignUp) {
        ...
        if (data.session && data.user) {
          // User created and confirmed - set localStorage flag and show success message
          localStorage.setItem('signedUpWithEmail_' + email.trim(), 'true');
          ...
          <form onSubmit={handleSubmit} className="space-y-5 px-1">
            ...
            <div className="space-y-3">
              ...
              <Button
                ...
                variant="outline"
                disabled={loading}
                className="w-full border-2 border-gray-300 text-gray-600 hover:bg-gray-50 hover:text-gray-700"
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
                  console.log('Google button clicked - inside form');
                  handleGoogleSignIn();
                }}
              >
